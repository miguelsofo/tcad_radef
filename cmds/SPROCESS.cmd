...
line x	location= 10.00	spacing= 250<nm> tag=SiBot	
...
init	resistivity=100 field=Phosphorus wafer.orient= {1 0 0} notch.direction= {0 -1 1}
...
implant	energy= 60<keV>	dose=2.5e15	tilt=7.00<degree>	rotation=0.00<degree>	Boron	beam.dose
strip	photoresist
...
contact	name=k.cont	silicon		xlo=10.0-$bu	xhi=10.0+$bu	ylo=$lef+$bu	yhi=$rig+$bu	box	add
